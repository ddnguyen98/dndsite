            ...
            <div>
                <Navbar className={styles.nav__navbar1} expand="md">
                    <Container>
                        ...
                        <NavbarText className={styles.nav__loggedIn}>User Logged In</NavbarText>
                    </Container>
                </Navbar>    
                <Navbar className={styles.nav__navbar2} expand="md">
                    <Container>
                        ...
                        <Link to="/register"><NavbarText>Register</NavbarText></Link>
                        <Link to="/login"><NavbarText>Login</NavbarText></Link>
                    </Container>
                </Navbar>    
            </div>
        );
